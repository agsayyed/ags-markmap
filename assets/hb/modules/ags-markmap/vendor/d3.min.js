!(function (t, n) {
  ...
  function ye(t) {
    return (
      t instanceof Kn || (t = de(t)), t ? new _e((t = t.rgb()).r, t.g, t.b, t.opacity) : new _e()
    )
  }
  function ve(t, n, e, r) {
  ...
  Wn(Kn, de, {
    ...
    Wn(
      ...
      Zn(Kn, {
        brighter: function (t) {
          return (
            (t = null == t ? Jn : Math.pow(Jn, t)), new Te(this.h, this.s, this.l * t, this.opacity)
          )
        },
        darker: function (t) {
          return (
            (t = null == t ? Qn : Math.pow(Qn, t)), new Te(this.h, this.s, this.l * t, this.opacity)
          )
        },
        rgb: function () {
  ...
  Wn(
    ...
    Zn(Kn, {
      brighter: function (t) {
        return (
          (t = null == t ? Jn : Math.pow(Jn, t)), new nr(this.h, this.s, this.l * t, this.opacity)
        )
      },
      darker: function (t) {
        return (
          (t = null == t ? Qn : Math.pow(Qn, t)), new nr(this.h, this.s, this.l * t, this.opacity)
        )
      },
      rgb: function () {
  ...
  function bi(t, n) {
    var e
    return ('number' == typeof n ? _r : n instanceof de ? sr : (e = de(n)) ? ((n = e), sr) : wr)(
      t,
      n
    )
  }
    ...
    selectAll: function (t) {
      ...
      for (var r = this._groups, i = r.length, o = [], a = [], u = 0; u < i; ++u)
        for (var c, f = r[u], s = f.length, l = 0; l < s; ++l)
          if ((c = f[l])) {
            for (
              var h, d = t.call(c, c.__data__, l, f), p = pi(c, e), g = 0, y = d.length;
              g < y;
              ++g
            )
  ...
  function ka() {
    ...
    function o(e, i) {
      ...
      return (
        (function (e, r, i) {
          ...
          for (; ++u < n - 1; ) {
            for (
              o = -1, f = e[u * t + t] >= r, s = e[u * t] >= r, Ea[(f << 1) | (s << 2)].forEach(p);
              ++o < t - 1;
    ...
    return (
      ...
      (i.thresholds = function (t) {
        return arguments.length
          ? ((e = 'function' == typeof t ? t : Array.isArray(t) ? wa(ma.call(t)) : wa(t)), i)
          : e
      }),
      (i.smooth = function (t) {
  ...
  function _p(n, e, r, i) {
    ...
    switch ((i = ac(null == i ? ',f' : i)).type) {
      case 's':
        ...
        return (
          null != i.precision || isNaN((o = vc(a, u))) || (i.precision = o), t.formatPrefix(i, u)
        )
      case '':
      case 'e':
      case 'g':
    ...
    function A(t, n, e, r) {
      for (var i, o, a = 0, u = n.length, c = e.length; a < u; ) {
        ...
        if (37 === (i = n.charCodeAt(a++))) {
          if (((i = n.charAt(a++)), !(o = x[i in iy ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0))
            return -1
  ...
  ;(ex.prototype = tx.prototype),
      ...
      function y(t, n) {
        if (i.call(this, t, n)) {
          var e,
            ...
            c = a.length
          for (e = 0; e < c; ++e)
            (r = b(this, u, t, n, a[e].identifier, a[e])) && (Un(t), r('start', t, a[e]))
        }
      }
      function v(t) {
        var n,
    ...
    (t.geoPath = function (t, n) {
      ...
      function o(t) {
        return (
          t && ('function' == typeof i && r.pointRadius(+i.apply(this, arguments)), Wc(t, e(r))),
          r.result()
        )
      }
      return (
      ...
      function k(t, ...r) {
        if (this.__zooming) {
          ...
          if ((a.touch1 && !a.touch0 && ((a.touch0 = a.touch1), delete a.touch1), a.touch0))
            ...
            (a.end(), 2 === a.taps && ((o = In(o, this)), Math.hypot(n[0] - o[0], n[1] - o[1]) < g))
          ) {
